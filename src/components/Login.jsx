  ...
  return (
    <div>
      ...
      <div className="border p-8 rounded-md w-[400px] mx-auto my-16 animate__animated animate__fadeIn">
        ...
        <form className="flex flex-col gap-x-8 gap-y-4" onSubmit={storeData}>
          ...
          <div className="flex justify-between col-span-2 items-center">
            <button className="bg-[#64b496] w-fit px-6 py-2.5 rounded mt-2 text-white font-semibold hover:bg-black duration-300">
              Login
            </button>
